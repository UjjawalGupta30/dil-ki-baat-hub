...
export const ACTS: Act[] = [
  ...
  },
  {
    ...
    body: "Millions of years ago, isolation meant death. Your brain registers loneliness not as a flaw, but as a biological survival signal, just like hunger.",
    bg: hexToRgb("#12091A"),
    ink: hexToRgb("#C89BE8"),
  ...
  },
  {
    ...
    body: "We traded tribes for cities, factories and screens. We get busy with work, adulting and overthinking at 2 AM, sacrificing connection for convenience.",
    bg: hexToRgb("#170A0F"),
    ink: hexToRgb("#8C8FA3"),
    accent: hexToRgb("#FFB800"),
  },
  {
    ...
    body: "Isolation breeds overthinking. We misinterpret neutral signals, assume the worst and pull away before anyone can reject us.",
    bg: hexToRgb("#1A0A0A"),
    ink: hexToRgb("#E08A6A"),
  ...
  },
  {
    ...
    body: "The first step to freedom is accepting that feeling lonely is human. Unspoken weight only shrinks when you let it out.",
    bg: hexToRgb("#2E1408"),
    ink: hexToRgb("#E2C382"),
  ...
  },
  {
    ...
    body: "Someone is on the other side of this. Open the room, stay as long as it helps, and let it disappear when you are done.",
    bg: hexToRgb("#1A120B"),
    ink: hexToRgb("#FFB35C"),
    accent: hexToRgb("#FFD98A"),
  },
